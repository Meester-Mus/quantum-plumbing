...
def main():
    ...
    layer = PotentialFCLayer(
        in_features=10, out_features=5, num_potentials=8  # Size of thinking space
    )
    ...
    print("     Knows: Only the best choice")
    print()
    print("   Quantum Plumbing: output + H (thinking space)")
    print(f"     Output shape: {output.shape}")
    print(f"     H shape: {H.shape}")
    print("     Knows: Best choice PLUS all alternatives")
    print()

    # Verify the network is thinking
    print("7. Verifying thinking happens...")
    print("   Output is weighted combination of H")
